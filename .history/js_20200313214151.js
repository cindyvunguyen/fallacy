...
function fallacyChange(state) {
    switch(state) {
        case 0:
            document.getElementById("#tfp-text").innerHTML = "<p><b>Appeal to Emotion</b> is an argument that is made due to the manipulation of emotions,<br>rather than using valid reasoning.</p>";
        case 1:
            document.getElementById("#tfp-text").innerHTML = "<p><b>Ad Hominem</b> is an argument that is built around an emotional appeal,<br>rather than logical appeal.</p>";
        break;
    }
}
